...
def test_zeros_parse_3():
    parsed = _parse(b"\x00\x00\x00\x01hell\x00\x00\x00\x00\x00\x00\x00\x00world")
    assert len(parsed) == 1
    assert parsed[0][0].type == b"hell"
    assert parsed[0][1] == b"world"
...
def test_moov_build():
    data = (
        ...
        b"\x00\x00\x00\x00box1\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
