...
class GeotagImagesFromExifToolBothImageAndVideo(GeotagImagesFromGeneric):
    ...
    def to_description(self) -> T.List[types.ImageMetadataOrError]:
        ...
        et_image_metadatas, et_error_metadatas = types.separate_errors(
            et_image_metadata_or_errors
        )
        final_image_metadatas.extend(et_image_metadatas)
        error_metadata_by_image_path = {m.filename: m for m in et_error_metadatas}
