def apply_camera_specific_config(vars_args):
    # Check for Blackvue
    if "device_make" in vars_args and vars_args['device_make'] and vars_args['device_make'].lower() == 'blackvue' or "geotag_source" in vars_args and vars_args["geotag_source"] == 'blackvue_videos':
