...
"""
    ...
    def add_basic_arguments(self, parser):
        ...
        parser.add_argument(
            "--organization_keys", help="Organizations which own the imagery"
        )
        parser.add_argument(
            "--start_time", help="Since when to pull the images (YYYY-MM-DD)"
        )
        parser.add_argument(
            "--end_time", help="Until when to pull the images (YYYY-MM-DD)"
        )
        parser.add_argument(
            "--private",
