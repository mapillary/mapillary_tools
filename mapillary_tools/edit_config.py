...
def edit_config(config_file=None, user_name=None, user_email=None, user_password=None, force_overwrite=False, user_key=None, api_version=1.0, upload_type='Video'):
