...
# check
$FOLDER="dist\win\mapillary_tools"
$SOURCE="dist\win\mapillary_tools\mapillary_tools.exe"
dist\win\mapillary_tools\mapillary_tools.exe --version
$VERSION_OUTPUT=dist\win\mapillary_tools\mapillary_tools.exe --version
...
cd dist\win
Compress-Archive -Path mapillary_tools -DestinationPath ..\..\"$TARGET"
cd ..\..\
